...
PICS = (
    environ.get(
        "PICS",
        "https://ibb.co/cSJdLj5H https://ibb.co/cSJdLj5H",
    )
).split()  # Sample pic
NOR_IMG = environ.get("NOR_IMG", "https://ibb.co/cSJdLj5H")
MELCOW_PHOTO = environ.get("MELCOW_PHOTO", "https://ibb.co/cSJdLj5H")
SPELL_IMG = environ.get("SPELL_IMG", "https://ibb.co/cSJdLj5H")
...
auth_req_channels = environ.get(
    "AUTH_REQ_CHANNELS", "-1002233419443, -1002593253594"
...
# ============================
QR_CODE = environ.get(
    "QR_CODE", "https://graph.org/file/841c2ee3db0fc.jpg"
...
# ============================
GRP_LNK = environ.get("GRP_LNK", "https://t.me/hd_freak")  # Group link for the bot
OWNER_LNK = environ.get("OWNER_LNK", "https://t.me/hd_freak")  # Owner link for the bot
UPDATE_CHNL_LNK = environ.get(
    "UPDATE_CHNL_LNK", "https://t.me/hd_freak"
...
BUTTON_MODE = is_enabled(
    (environ.get("BUTTON_MODE", "True")), True
